...
import { FaSearch, FaShoppingCart, FaUser, FaBox, FaSpinner } from "react-icons/fa";
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <div className="divide-y">
                {results.products.map(product => (
                  <Link key={product.id} to="/products" className="flex justify-between items-center p-3 hover:bg-pink/5 rounded-lg transition">
                    <div><span className="font-medium">{product.name}</span><span className="text-xs text-gray-400 ml-2">{product.category}</span></div>
